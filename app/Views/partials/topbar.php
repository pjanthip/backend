  ...
  <div class="offcanvas-body">
    ...
    <div class="card mb-3">
      <div class="card-body">
        ...
        <a
          href="https://1.envato.market/zNkqj6"
          target="_blank"
          ><img src="<?= base_url('assets/images/layout/img-announcement-2.png') ?>" alt="img" class="img-fluid"
        /></a>
      </div>
    </div>
    ...
    <div class="card mb-3">
      <div class="card-body">
        ...
        <img src="<?= base_url('assets/images/layout/img-announcement-4.png') ?>" alt="img" class="img-fluid" />
      </div>
    </div>
  </div>
</div>
