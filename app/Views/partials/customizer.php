        ...
        <li class="list-group-item">
          ...
          <div class="theme-main-layout d-flex align-center gap-1 w-100">
            <a href="#!" data-bs-toggle="tooltip" title="Vertical" class="active" data-value="vertical">
              <img src="<?= base_url('assets/images/customizer/caption-on.svg') ?>" alt="img" class="img-fluid" />
            </a>
            <a href="#!" data-bs-toggle="tooltip" title="Horizontal" data-value="horizontal">
              <img src="<?= base_url('assets/images/customizer/horizontal.svg') ?>" alt="img" class="img-fluid" />
            </a>
            <a href="#!" data-bs-toggle="tooltip" title="Color Header" data-value="color-header">
              <img src="<?= base_url('assets/images/customizer/color-header.svg') ?>" alt="img" class="img-fluid" />
            </a>
            <a href="#!" data-bs-toggle="tooltip" title="Compact" data-value="compact">
              <img src="<?= base_url('assets/images/customizer/compact.svg') ?>" alt="img" class="img-fluid" />
            </a>
            <a href="#!" data-bs-toggle="tooltip" title="Tab" data-value="tab">
              <img src="<?= base_url('assets/images/customizer/tab.svg') ?>" alt="img" class="img-fluid" />
            </a>
          </div>
        </li>
        <li class="list-group-item">
            ...
            <div class="col-6">
              <div class="d-grid">
                <button
                  ...
                  title="Caption Hide"
                >
                  <img src="<?= base_url('assets/images/customizer/caption-off.svg') ?>" alt="img" class="img-fluid" />
                </button>
              </div>
            </div>
          </div>
              ...
              <div class="col-6">
                <div class="d-grid">
                  <button
                    ...
                    title="LTR"
                  >
                    <img src="<?= base_url('assets/images/customizer/ltr.svg') ?>" alt="img" class="img-fluid" />
                  </button>
                </div>
              </div>
              <div class="col-6">
                <div class="d-grid">
                  <button
                    ...
                    title="RTL"
                  >
                    <img src="<?= base_url('assets/images/customizer/rtl.svg') ?>" alt="img" class="img-fluid" />
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="col-6">
                <div class="d-grid">
                  <button
                    ...
                    title="Full Width"
                  >
                    <img src="<?= base_url('assets/images/customizer/full.svg') ?>" alt="img" class="img-fluid" />
                  </button>
                </div>
              </div>
              <div class="col-6">
                <div class="d-grid">
                  <button
                    ...
                    title="Fixed Width"
                  >
                    <img src="<?= base_url('assets/images/customizer/fixed.svg') ?>" alt="img" class="img-fluid" />
                  </button>
                </div>
              </div>
            </div>
